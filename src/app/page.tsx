...
export default function Home() {
  return (
    <div className="qurb-page">
      ...
      {/* USP ticker (decorative; duplicated once for a seamless loop) */}
      ...
      <main id="top">
        ...
        <section className="hero">
          <p className="hero__kicker">
            qurb · Peek <span className="kicker">before</span> you Park
          </p>
          <p className="hero__eyebrow">Parkeervergelijker · Nederland</p>
          <h1 className="hero__title">
            Weet wat je écht betaalt aan parkeren.
          </h1>
          <p className="hero__sub">
            Parkmobile, EasyPark, Yellowbrick, ANWB Parkeren of Q-Park — elke
            app rekent andere servicekosten. Qurb vergelijkt ze allemaal op één
            plek, zodat jij de goedkoopste keuze maakt.
          </p>
        </section>

        {/* Live regions: errors + results */}
        <div
          className="status"
          id="error"
          role="alert"
        ...
        <section className="section" id="apps">
          ...
          <p className="lede" style={{ marginBlockStart: "24px" }}>
            Benieuwd welke app structureel het goedkoopst is?{" "}
            <Link
              href="/goedkoopste-parkeerapp"
              style={{ color: "var(--brand-strong)", fontWeight: 600 }}
            >
              Bekijk de volledige app vergelijking →
            </Link>
          </p>
        </section>
        ...
        <section className="section">
          <p className="eyebrow">Beschikbaar in</p>
          <h2 className="title">Jouw stad</h2>
          <ul className="chips">
            {(
              [
                ["Amsterdam", "/amsterdam"],
